...
def main():
    ...
    for row in ml_data['meteorite_landings']:
        ...
        result = (check_hemisphere(float(row['reclat']), float(row['reclong'])))
   
        if result == 'Northern & Eastern':
            total_ne += 1
      
        elif result == 'Northern & Western':
    	    total_nw += 1
      
        elif result == 'Southern & Easter':
    	    total_se += 1 
      
        elif result == 'Southern & Western': 
    	    total_sw += 1
    
	
            
    print("There were", total_ne, "meteors found in the Northern & Eastern quadrant")
    print("There were", total_nw, "meteors found in the Northern & Western quadrant")
    print("There were", total_se, "meteors found in the Southern & Eastern quadrant")
    print("There were", total_sw, "meteors found in the Southern & Western quadrant")

    print("Class sumamry data:\n","The", count_classes(ml_data['meteorite_landings'], 'recclass'))
